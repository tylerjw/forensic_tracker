...
class Window(Frame):
    ...
    def add(self):
        filenames = tkinter.filedialog.askopenfilenames(title='Select input .xml files', filetypes=[('xml','*.xml')],
                                              multiple=True)
    ...
    def get_outfn(self):
        filename = tkinter.filedialog.asksaveasfilename(title='Output file', initialfile='forensic_track.xls',
